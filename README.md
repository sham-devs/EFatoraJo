Here is the revised documentation with the requested change to the final line.

-----

# JoFatora .NET Client

[](https://www.nuget.org/packages/E.FatoraJo/)
...
تم بناؤه بهيكلية نظيفة ودعم كامل للعمليات غير المتزامنة، لتسهيل الالتزام بالتشريعية الضريبية المحلية وجعل عملية الربط بسيطة وسريعة.
...
## Table of Contents
  ...
  - [Validation](https://www.google.com/search?q=%23validation)
  - [Error Handling](https://www.google.com/search?q=%23error-handling)
  - [Response Handling](https://www.google.com/search?q=%23response-handling)
...
Please report issues on our [GitHub Issues](https://github.com/yourorg/jofatora-dotnet-sdk/issues) page with:
...
MIT License - see [LICENSE](https://www.google.com/search?q=LICENSE) file for the full license text.
...
## Support
  ...
  * 🐛 **Issues**: [GitHub Issues](https://github.com/yourorg/jofatora-dotnet-sdk/issues)
  * 💬 **Discussions**: [GitHub Discussions](https://github.com/yourorg/jofatora-dotnet-sdk/discussions)
